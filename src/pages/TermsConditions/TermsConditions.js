    ...
    return (
        <div className="relative z-[51]">
            ...
            <motion.div
                ...
                className="dark:text-white px-8  text-primary2 w-[80%] h-[80%] top-[10%] dark:bg-[#282828] bg-slate-100 fixed  left-0 right-0 overflow-y-auto p-6 pb-12 mx-auto  rounded-md shadow-md no-scrollbar"
            >
                <span
                ...
                <p className="my-1">Please read these terms and conditions carefully before using Our Service.</p>
                ...
                <ul className="flex flex-col gap-3">
                    ...
                    <li className="ml-8 list-disc">
                        <p className="my-1">
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Snap Share.
                        </p>
                    </li>
                    <li className="ml-8 list-disc">
                        <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Acknowledgment</h1>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Links to Other Websites</h1>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Termination</h1>
                <p className="my-1">
                ...
                <p className="my-1">Upon termination, Your right to use the Service will cease immediately.</p>
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Limitation of Liability</h1>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Governing Law</h1>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Disputes Resolution</h1>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Severability and Waiver</h1>
                <h2 className="text-[1.6rem] font-semibold mt-2">Severability</h2>
                <p className="my-1">
                    If any provision of these Terms is held to be unenforceable or invalid, such provision will be
                    changed and interpreted to accomplish the objectives of such provision to the greatest extent
                    possible under applicable law and the remaining provisions will continue in full force and effect.
                </p>
                <h2 className="text-[1.6rem] font-semibold mt-2">Waiver</h2>
                <p className="my-1">
                ...
                <h1 className="dark:text-primary1 text-blue-600 text-[2rem] mt-4 font-bold">Contact Us</h1>
                <p className="my-1">If you have any questions about these Terms and Conditions, You can contact us:</p>
                <ul className="flex flex-col gap-3">
                    <li className="ml-8 list-disc">
                        <p className="my-1">
                            By email:{" "}
