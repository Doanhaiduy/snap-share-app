...
function ItemSearch({ user, handleHideResult }) {
    ...
    return (
        <Link
            ...
            className="flex items-center gap-2 hover:bg-blue-700 dark:hover:bg-yellow-500 dark:hover:text-primary2 cursor-pointer hover:text-white  nin-h-[70px] py-1 px-2 border-t-[1px] border-b-[1px]"
        >
